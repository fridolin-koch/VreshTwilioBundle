 ...
 */
abstract class ListResource extends Resource implements \IteratorAggregate
{
    private $_page;
     ...
     * @return InstanceResource The resource
     */
     ...
     *
     * @return InstanceResource The created resource
     */
